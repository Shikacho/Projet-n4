(function($) {
  ...
  $.fn.mauGallery.methods = {
    ...
    prevImage() {
      ...
      if (!activeImage) {
        console.error("L'image active n'a pas pu être trouvée.");
        return;
      }
      ...
      if (imagesCollection.length === 0) {
        console.error("Aucune image trouvée pour le tag actif.");
        return;
      }
    ...
    filterByTag() {
      ...
      console.log("Valeur de data-images-toggle :", $(this).data("images-toggle"));
      ...
      if (tag === undefined) {
        console.error("L'attribut data-images-toggle est manquant ou incorrect.");
        return;
      }
